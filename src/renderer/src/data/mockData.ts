...
export const sampleModule: Module = {
  ...
  description:
    'A foundational course that introduces the basic principles of computer science, programming concepts, and computational thinking.',
  content: {
    lessons: [
      {
        id: 'lesson-1',
      ...
      },
      {
        ...
        content: [
          ...
          },
          {
            type: 'text',
            content:
              "When learning to program, it's important to understand fundamental concepts like variables, data types, control structures, and functions. These building blocks are common across most programming languages, though the syntax may differ."
          },
          {
            type: 'video',
        ...
        content: [
          {
            type: 'text',
            content:
              'Algorithms are step-by-step procedures for solving problems, while data structures are ways of organizing and storing data. Together, they form the cornerstone of computer science and efficient problem-solving.'
          },
          {
            type: 'image',
        ...
        content: [
          {
            type: 'text',
            content:
              'Computer Architecture is the conceptual design and fundamental operational structure of a computer system. It focuses on the way computer components are organized and integrated.'
          },
          {
            type: 'text',
            content:
          ...
          },
          {
            type: 'text',
            content:
              'Modern computers use the Von Neumann architecture, which stores both program instructions and data in the same memory. This design allows for flexibility but can create a bottleneck between the CPU and memory, known as the Von Neumann bottleneck.'
          }
        ]
      },
      {
        ...
        content: [
          {
            type: 'text',
            content:
              'The Software Development Life Cycle (SDLC) is a process used by the software industry to design, develop, and test high-quality software. It consists of several phases that help organize the development process.'
          },
          {
            type: 'image',
    ...
    quizzes: [
      {
        ...
        questions: [
          ...
          },
          {
            ...
            options: ['Python', 'JavaScript', 'HTML', 'Algorithm'],
            correctAnswer: 3
          },
          {
            id: 'q1-3',
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            id: 'q2-3',
            question:
              'Which of the following is NOT a phase in the Software Development Life Cycle?',
            options: ['Planning', 'Marketing', 'Testing', 'Maintenance'],
            correctAnswer: 1
          },
          {
            id: 'q2-4',
